...
(function () {
  ...
  1: [function (require, module, exports) {
    ...
    "../parts/authorization_form.js": 2,
    "../parts/form_modal.js": 3,
    "../parts/main_form.js": 4,
    "../parts/modal_open.js": 5,
    "../parts/slider.js": 6,
    "../parts/smooth_scrolling.js": 7,
    "../parts/tarif.js": 8,
    "../parts/transition_page.js": 9,
    "../parts/video.js": 10,
    "babel-polyfill": 11
  }],
  2: [function (require, module, exports) {
    function authorizationForm() {
      //форма авторизации
      var formAutorization = document.querySelectorAll('.popup-form_form')[0];
      var inpt = formAutorization.getElementsByTagName('input'),
          //поле имени
      ...
      phoneForm.addEventListener('input', function () {
        ...
        function checkValue(val) {
          ...
          var currentVal = val.replace(/[^\d]+/g, '');
      ...
      var nameFormValue; //кирилица в поле ввода имени

      nameForm.addEventListener('keypress', function () {
        nameFormValue = nameForm.value; //проверка на пустую строку
      ...
      formAutorization.addEventListener('submit', function (event) {
        ...
        var formData = new FormData(formAutorization); //отправляем форму
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {} else if (request.readyState === 4) {
            if (request.status === 200 && request.status < 300) {
              ...
              document.querySelector('.popup-form-alert').style.display = 'block'; //добавляем контент на страницу
            } else {
              formAutorization.style.display = 'none';
  ...
  3: [function (require, module, exports) {
    function formModal() {
      var form = document.querySelectorAll('.popup-form_form')[1],
      ...
      phoneModal.addEventListener('focus', function () {
      ...
      var nameValue; //кирилица в поле ввода имени

      nameModal.addEventListener('keypress', function () {
        nameValue = nameModal.value; //проверка на пустую строку
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {} else if (request.readyState === 4) {
            if (request.status === 200 && request.status < 300) {
              ...
              document.querySelector('.js-overlay-order').style.display = 'block'; //добавляем контент на страницу
            } else {
              form.style.display = 'none';
  ...
  4: [function (require, module, exports) {
    function mainForm() {
      var main = document.querySelector('.form-group'),
      ...
      name.addEventListener('keypress', function () {
        nameValue = name.value; //проверка на пустую строку
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {} else if (request.readyState === 4) {
            if (request.status === 200 && request.status < 300) {
              ...
              document.querySelector('.form-group-alert').style.display = 'block'; //добавляем контент на страницу
            } else {
              formBlock.style.display = 'none';
  ...
  5: [function (require, module, exports) {
    function modalOpen() {
      var headerLoginBtn = document.querySelector('.header-login__button'),
          footerLoginBtn = document.querySelector('.footer-login__button'),
          overlay = document.querySelector('.overlay'),
          close = document.querySelector('.popup .popup-close'); //обработчики на кнопки "Войти"
  ...
  6: [function (require, module, exports) {
    function slider() {
      var slideIndex = 1,
          ...
          dots = document.getElementsByClassName('dot'); //функция показа слайдов
      ...
      var showSlides = function showSlides(n) {
        ...
        for (var _i = 0; _i < dots.length; _i++) {
          dots[_i].classList.remove('dot__active');
        } //отображаем нужный слайд


        slides[slideIndex - 1].style.display = 'block'; //добавляем анимацию на слайд

        slides[slideIndex - 1].classList.add('animated', 'fadeIn'); //делаем соответствующую точку активной
      ...
      showSlides(1);
      slideIndex = 2; //отображение слайдов с интервалом в 3 секунды

      setInterval(function () {
        showSlides(slideIndex);
        slideIndex++;
      }, 3000); //переключение на выбранный слайд
  ...
  7: [function (require, module, exports) {
    function smoothScrolling() {
      ...
      ;
      var navigation = document.querySelector('.header-nav-menu');
  ...
  8: [function (require, module, exports) {
    function tarif() {
      var jsOverlayForm = document.querySelector('.js-overlay-thank-you'),
          ...
          basic = document.getElementById('basic'); //создаём обработчик на родительский блок
      ...
      pricing.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('pricing-block__button')) {
          jsOverlayForm.style.display = 'block'; // проверяем на какой из кнопок произошло событие и устанавливаем соответствующую радио-кнопку в отмеченное состояние
        }
      ...
      jsOverlayForm.addEventListener('click', function (event) {
  ...
  9: [function (require, module, exports) {
    function transitionPage() {
      var elemBtn = document.getElementsByClassName('header-button__main button button__big')[0];
  ...
  10: [function (require, module, exports) {
    function videoPlayer() {
      ...
      preview = document.createElement('img'),
          playBtn = document.createElement('img'); //устанавливаем необходимые стили css
  ...
  11: [function (require, module, exports) {
    ...
    "core-js/shim": 335,
    "regenerator-runtime/runtime": 336
  }],
  ...
  282: [function (require, module, exports) {
    ...
    "./_set-collection-from": 104
  }],
  283: [function (require, module, exports) {
    // https://tc39.github.io/proposal-setmap-offrom/#sec-map.of
    require('./_set-collection-of')('Map');
  }, {
    "./_set-collection-of": 105
  }],
  ...
  335: [function (require, module, exports) {
    ...
    "./modules/es7.array.flat-map": 276,
    "./modules/es7.array.flatten": 277,
    "./modules/es7.array.includes": 278,
    "./modules/es7.asap": 279,
    "./modules/es7.error.is-error": 280,
    "./modules/es7.global": 281,
    "./modules/es7.map.from": 282,
    "./modules/es7.map.of": 283,
    "./modules/es7.map.to-json": 284,
    "./modules/es7.math.clamp": 285,
    "./modules/es7.math.deg-per-rad": 286,
    "./modules/es7.math.degrees": 287,
    "./modules/es7.math.fscale": 288,
    "./modules/es7.math.iaddh": 289,
    "./modules/es7.math.imulh": 290,
    "./modules/es7.math.isubh": 291,
    "./modules/es7.math.rad-per-deg": 292,
    "./modules/es7.math.radians": 293,
    "./modules/es7.math.scale": 294,
    "./modules/es7.math.signbit": 295,
    "./modules/es7.math.umulh": 296,
    "./modules/es7.object.define-getter": 297,
    "./modules/es7.object.define-setter": 298,
    "./modules/es7.object.entries": 299,
    "./modules/es7.object.get-own-property-descriptors": 300,
    "./modules/es7.object.lookup-getter": 301,
    "./modules/es7.object.lookup-setter": 302,
    "./modules/es7.object.values": 303,
    "./modules/es7.observable": 304,
    "./modules/es7.promise.finally": 305,
    "./modules/es7.promise.try": 306,
    "./modules/es7.reflect.define-metadata": 307,
    "./modules/es7.reflect.delete-metadata": 308,
    "./modules/es7.reflect.get-metadata": 310,
    "./modules/es7.reflect.get-metadata-keys": 309,
    "./modules/es7.reflect.get-own-metadata": 312,
    "./modules/es7.reflect.get-own-metadata-keys": 311,
    "./modules/es7.reflect.has-metadata": 313,
    "./modules/es7.reflect.has-own-metadata": 314,
    "./modules/es7.reflect.metadata": 315,
    "./modules/es7.set.from": 316,
    "./modules/es7.set.of": 317,
    "./modules/es7.set.to-json": 318,
    "./modules/es7.string.at": 319,
    "./modules/es7.string.match-all": 320,
    "./modules/es7.string.pad-end": 321,
    "./modules/es7.string.pad-start": 322,
    "./modules/es7.string.trim-left": 323,
    "./modules/es7.string.trim-right": 324,
    "./modules/es7.symbol.async-iterator": 325,
    "./modules/es7.symbol.observable": 326,
    "./modules/es7.system.global": 327,
    "./modules/es7.weak-map.from": 328,
    "./modules/es7.weak-map.of": 329,
    "./modules/es7.weak-set.from": 330,
    "./modules/es7.weak-set.of": 331,
    "./modules/web.dom.iterable": 332,
    "./modules/web.immediate": 333,
    "./modules/web.timers": 334
  }],
