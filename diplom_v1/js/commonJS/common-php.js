...
(function () {
  ...
  1: [function (require, module, exports) {
    ...
    "../parts/active_nav.js": 2,
    "../parts/fon.js": 3,
    "../parts/foto_guest.js": 4,
    "../parts/guest_list.js": 5,
    "../parts/invate_guest.js": 6,
    "../parts/mail_guest.js": 7,
    "../parts/map.js": 8,
    "../parts/mobail_menu.js": 9,
    "../parts/mobaile_tool.js": 10,
    "../parts/video_vidget.js": 11,
    "../parts/wish_edit.js": 12,
    "babel-polyfill": 13
  }],
  2: [function (require, module, exports) {
    function activNav() {
      var tabs = document.querySelectorAll('.navigation li');
  ...
  3: [function (require, module, exports) {
    function fon() {
      var siteBuilder = document.getElementById('site-builder'),
          minimized = document.querySelectorAll('.minimized'); //адhtc увеличенного изображения
      ...
      var closeMaxImage = document.querySelector('.close-popup-maxImage');
        ...
        if (target.className === 'minimized') {
          for (var i = 0; i < minimized.length; i++) {
            if (target === minimized[i]) {
              ...
              divImage.innerHTML = "<div class=\"overlay-img\"></div><div class=\"position-image\" ><img class=\"minimaze-max\" src='".concat(target.src, "'/><div id=\"close-popup\">X</div></div>");
      ...
      closeMaxImage.addEventListener('click', function (e) {
        var close = document.getElementById('close-popup');
        var over = document.querySelector('.overlay-img');
  ...
  5: [function (require, module, exports) {
    function guestList() {
      ...
      btnSend.addEventListener('click', function (e) {
        ...
        p.innerHTML = "".concat(input[0].value, " ").concat(input[1].value);
        p.classList.add("builder".concat(column, "-block__text"));
        p.innerHTML = "".concat(input[0].value, " ").concat(input[1].value); //помещаем гостей поочерёдно в разные колонки
      ...
      deleteBtn.addEventListener('click', function (e) {
        e.preventDefault(); //очищаем колонки
  ...
  6: [function (require, module, exports) {
    function inviteGuest() {
      var editBtn = document.getElementsByClassName('choice__btn choice__btn-1')[0],
          deleteBtn = document.getElementsByClassName('choice__btn choice__btn-4')[0],
          modal = document.getElementById('invate-modal'),
          saveBtn = document.querySelector('.invate-modal-input-save');
      var input = document.querySelectorAll('.invate-modal-input input'),
      ...
      var invateBlock = document.querySelectorAll('.invitation-block__item div');
      ...
      saveBtn.addEventListener('click', function (e) {
        ...
        for (var i = 0; i < invateBlock.length; i++) {
          if (input[i].value) {
            // console.log(input[i].value);
            invateBlock[i].innerHTML = input[i].value;
            input[i].value = '';
          } else {
            for (var j = 0; j < invateBlock.length; j++) {
        ...
        request.onreadystatechange = function () {
          if (request.readyState < 4) {} else if (request.readyState === 4) {
            if (request.status === 200 && request.status < 300) {
              ...
              console.log('ok'); //добавляем контент на страницу
            } else {
              console.log('not ok');
              box.style.display = 'none';
  ...
  8: [function (require, module, exports) {
    function maps() {
      var tab = document.getElementsByClassName("location-button__map"),
          // map =	document.getElementById('map'),
      adress = document.getElementById("adress"),
          getAdress = document.getElementsByClassName("form-button__add button button__big")[0];
      ...
      function initGoogleMap() {
        ...
        var myLatlng = new google.maps.LatLng(47.946246, 33.441013);
        var mapOption = {
          zoom: 16,
          //позиционируем карту
          center: myLatlng,
        ...
        var map = new google.maps.Map(document.getElementById("map"), mapOption); //маркер
        ...
        var contentString = "<div>Тут будет проходить торжественное мероприятие</div>";
      ...
      function initYandexMap() {
        ...
        var mark = new ymaps.Placemark([47.946246, 33.441013]);
  ...
  9: [function (require, module, exports) {
    function mobailMenu() {
      var mobaileBtn = document.getElementsByClassName('header-main__link')[0],
          menu = document.getElementsByClassName('header-main-menu')[0];
      mobaileBtn.addEventListener('touchstart', function () {
  ...
  11: [function (require, module, exports) {
    function videoVidget() {
      var yuotube = document.querySelector('.youtube'),
      ...
      preview.setAttribute('alt', 'play'); //добавляем картинки в заданный блок

      yuotube.appendChild(preview);
      yuotube.appendChild(playBtn);
      var urlVideo = 'https://www.youtube.com/embed/q_th_D4VHC0?rel=0';

      var addVideo = function addVideo(url) {
        var iframe = "\n\t\t\t\t<iframe width=\"655\" height=\"403\" src=\"".concat(url, "\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen></iframe>\n\t\t\t\t"); //изменяем стили элемента для корректного отображения видео

        yuotube.classList.add('not-before'); //добавляем yuotube на страницу

        yuotube.innerHTML = iframe;
      }; //устанавливаем обработчик для запуска yuotube


      yuotube.addEventListener('click', function () {
        addVideo(urlVideo);
      });
      addVideoBtn.addEventListener('click', function (e) {
        e.preventDefault();
        var url = adressVideo.value; //замена в строке адреса для корректного отображения
  ...
  12: [function (require, module, exports) {
    function wishEdit() {
      ...
      sendWish.addEventListener('click', function (e) {
        e.preventDefault(); // console.log(inputWish);
  ...
  13: [function (require, module, exports) {
    ...
    "core-js/fn/regexp/escape": 14,
    "core-js/shim": 337,
    "regenerator-runtime/runtime": 338
  }],
  ...
  284: [function (require, module, exports) {
    ...
    "./_set-collection-from": 106
  }],
  285: [function (require, module, exports) {
    // https://tc39.github.io/proposal-setmap-offrom/#sec-map.of
    require('./_set-collection-of')('Map');
  }, {
    "./_set-collection-of": 107
  }],
  ...
  337: [function (require, module, exports) {
    ...
    "./modules/es7.array.flat-map": 278,
    "./modules/es7.array.flatten": 279,
    "./modules/es7.array.includes": 280,
    "./modules/es7.asap": 281,
    "./modules/es7.error.is-error": 282,
    "./modules/es7.global": 283,
    "./modules/es7.map.from": 284,
    "./modules/es7.map.of": 285,
    "./modules/es7.map.to-json": 286,
    "./modules/es7.math.clamp": 287,
    "./modules/es7.math.deg-per-rad": 288,
    "./modules/es7.math.degrees": 289,
    "./modules/es7.math.fscale": 290,
    "./modules/es7.math.iaddh": 291,
    "./modules/es7.math.imulh": 292,
    "./modules/es7.math.isubh": 293,
    "./modules/es7.math.rad-per-deg": 294,
    "./modules/es7.math.radians": 295,
    "./modules/es7.math.scale": 296,
    "./modules/es7.math.signbit": 297,
    "./modules/es7.math.umulh": 298,
    "./modules/es7.object.define-getter": 299,
    "./modules/es7.object.define-setter": 300,
    "./modules/es7.object.entries": 301,
    "./modules/es7.object.get-own-property-descriptors": 302,
    "./modules/es7.object.lookup-getter": 303,
    "./modules/es7.object.lookup-setter": 304,
    "./modules/es7.object.values": 305,
    "./modules/es7.observable": 306,
    "./modules/es7.promise.finally": 307,
    "./modules/es7.promise.try": 308,
    "./modules/es7.reflect.define-metadata": 309,
    "./modules/es7.reflect.delete-metadata": 310,
    "./modules/es7.reflect.get-metadata": 312,
    "./modules/es7.reflect.get-metadata-keys": 311,
    "./modules/es7.reflect.get-own-metadata": 314,
    "./modules/es7.reflect.get-own-metadata-keys": 313,
    "./modules/es7.reflect.has-metadata": 315,
    "./modules/es7.reflect.has-own-metadata": 316,
    "./modules/es7.reflect.metadata": 317,
    "./modules/es7.set.from": 318,
    "./modules/es7.set.of": 319,
    "./modules/es7.set.to-json": 320,
    "./modules/es7.string.at": 321,
    "./modules/es7.string.match-all": 322,
    "./modules/es7.string.pad-end": 323,
    "./modules/es7.string.pad-start": 324,
    "./modules/es7.string.trim-left": 325,
    "./modules/es7.string.trim-right": 326,
    "./modules/es7.symbol.async-iterator": 327,
    "./modules/es7.symbol.observable": 328,
    "./modules/es7.system.global": 329,
    "./modules/es7.weak-map.from": 330,
    "./modules/es7.weak-map.of": 331,
    "./modules/es7.weak-set.from": 332,
    "./modules/es7.weak-set.of": 333,
    "./modules/web.dom.iterable": 334,
    "./modules/web.immediate": 335,
    "./modules/web.timers": 336
  }],
